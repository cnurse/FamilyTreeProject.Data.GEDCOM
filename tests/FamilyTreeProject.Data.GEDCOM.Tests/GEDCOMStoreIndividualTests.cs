...
{
    public class GEDCOMStoreIndividualTests : GEDCOMTestBase
    {
        ...
        public void GEDCOMStore_AddIndividual_Should_Create_Family_If_Father_Or_Mother_And_Family_Does_Not_Exist(string fileName, int id, string fatherId, string motherId, string updatedFileName)
        {
            //Arrange
            const string testFile = "AddIndividual.ged";
            var db = CreateStore($"{fileName}.ged", testFile);
        ...
        [Test]
        [TestCase("ThreeIndividuals_OneFamily", "1", "2", "ThreeIndividuals_OneFamily_AddIndividual")]
        [TestCase("ThreeIndividuals_OneFamilyHusband", "1", "", "ThreeIndividuals_OneFamilyHusband_AddIndividual")]
        [TestCase("ThreeIndividuals_OneFamilyWife", "", "2", "ThreeIndividuals_OneFamilyWife_AddIndividual")]
        public void GEDCOMStore_AddIndividual_Should_Update_Family_If_Father_Or_Mother_And_Family_Exists(string fileName, string fatherId, string motherId, string updatedFileName)
        {
            //Arrange
            const string testFile = "AddIndividual.ged";
            var db = CreateStore($"{fileName}.ged", testFile);
        ...
        public void GEDCOMStore_UpdateIndividual_Should_Create_Family_If_Father_Or_Mother_And_Family_Does_Not_Exist(string fileName, int idToUpdate, string fatherId, string motherId, string updatedFileName)
        {
            //Arrange
            const string testFile = "UpdateIndividual.ged";
            var db = CreateStore($"{fileName}.ged", testFile);
        ...
        public void GEDCOMStore_UpdateIndividual_Should_Update_Family_If_Father_Or_Mother_And_Family_Exists(string fileName, int idToUpdate, string fatherId, string motherId, string updatedFileName)
        {
            //Arrange
            const string testFile = "UpdateIndividual.ged";
            var db = CreateStore($"{fileName}.ged", testFile);
        ...
        public void GEDCOMStore_UpdateIndividual_Should_Add_Family_If_Father_Or_Mother_Is_Changed_And_New_Family_Does_Not_Exist(string fileName, int idToUpdate, string fatherId, string motherId, string updatedFileName)
        {
            //Arrange
            const string testFile = "UpdateIndividual.ged";
            var db = CreateStore($"{fileName}.ged", testFile);
        ...
        public void GEDCOMStore_UpdateIndividual_Should_Update_Family_If_Father_Or_Mother_Is_Changed_And_New_Family_Exists(string fileName, int idToUpdate, string fatherId, string motherId, string updatedFileName)
        {
            //Arrange
            const string testFile = "UpdateIndividual.ged";
            var db = CreateStore($"{fileName}.ged", testFile);
